...
const switchToLightBtn = document.querySelector('.light')
const switchToDarkBtn = document.querySelector('.dark')
...
switchToLightBtn.addEventListener('click', changeStyleToLight)
switchToDarkBtn.addEventListener('click', changeStyleToDark)